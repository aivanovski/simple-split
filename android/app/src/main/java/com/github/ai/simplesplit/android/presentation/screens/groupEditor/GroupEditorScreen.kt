...
import com.github.ai.simplesplit.android.presentation.core.compose.MenuItem
...
private fun GroupEditorScreen(
    ...
    val onMenuItemClick = rememberCallback { menuItem: MenuItem ->
        when (menuItem) {
            MenuItem.DONE -> onIntent.invoke(GroupEditorIntent.OnDoneClick)
        }
    }
    ...
    Scaffold(
        topBar = {
            TopBar(
                ...
                menuItems = listOf(MenuItem.DONE), // TODO: move to state
